...
buildPath=`pwd`
arch="Release"
target="SocialContactNative"
projectPath="SocialContactNative.xcodeproj"
library="SocialContactNativeLibrary"
hederFile="Include"
sourceFile="Release"
...
lipo -create ${buildPath}/lib_i386_x86.a ${buildPath}/lib_armv7_arm64.a -output ./lib${library}.a
...
rm ./Release/lib${library}.a
mv ./lib${library}.a ./Release
